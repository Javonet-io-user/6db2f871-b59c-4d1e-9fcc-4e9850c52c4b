  ...
  public static class Enumerator<T> extends ValueType
    ...
    public boolean hasNext() {
      if (hasNextValue == null) {
        Boolean result = (java.lang.Boolean) this.MoveNext();
        this.Reset();
        return result;
      }
      return hasNextValue;
    ...
    Boolean hasNextValue = null;

    @Override
    public T next() {
      hasNextValue = (java.lang.Boolean) this.MoveNext();
      if (hasNextValue) return (T) this.get_Current();
      return null;
    }
    /** GetProperty */
